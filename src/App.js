...
import { BrowserRouter as Router, Routes, Route } from "react-router-dom";          //  an npm package that enables you to implement dynamic routing in a web app
...
import UserSign from "./components/UserSign";
                                                       //router -->     //enables the navigation among views of various component
function App() {                                                                                                            
    return (
    <>
      <Router>
